\typeout{------------------------------------------------------------------}
\typeout{} 
\typeout{        Fichier de base modifie par : JC: 20 nov 2012} 
\typeout{                   sous licence GNU-GPL} 
\typeout{}
\typeout{------------------------------------------------------------------}

% Classe générale du document
   \documentclass[10pt]{report} % .10pt, 11pt, 12pt : taille de la police principale (10 par défaut)
...
%      \headsep       25pt   % distance de '3' à '4', la distance entre l'en-tête et le texte
      \textheight    230mm  % distance de '4' à '5', pour déterminer la hauteur du texte
...
%    % bas de page
      \footskip      5mm   % 30pt % distance de '5' à '6', la distance entre le texte et le bas de page
